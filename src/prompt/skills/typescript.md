---
name: typescript
description: "Enforce TypeScript conventions (types, imports, JSDoc). Use when: writing TypeScript code, reviewing PRs for type safety, or adding new exported functions."
---
...
- [Use `type` instead of `interface` where possible.](#interface-is-not-interface-but-interface)
